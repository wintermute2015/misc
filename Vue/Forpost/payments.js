		...
		Vue.component('payment-form', {
					...
					<fieldset class="sender-data form-section-wrapper">
						...
						<div class="form-section">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="senderSurname" placeholder="Прізвище відправника" v-model="amount">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="senderName" placeholder="Ім'я відправника" v-model="amount">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="senderPatronymic" placeholder="По-батькові відправника" v-model="amount">
								<div class="invalid-feedback">
			...
			methods: {
				setData() {
					if (appConfig) {
						if (appConfig.payment) {
							this.amount = appConfig.payment.amount;
						}
					}
				},
				goBack() {
